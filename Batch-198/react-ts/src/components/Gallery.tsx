...
export default function Gallery() {
  ...
  /*
    index: gọi là state
    setIndex: gọi là phương thức để thay đổi giá trị cho state index
    0: là giá trị khởi tạo ban đầu cho state index --> index = 0
  */

  function handleClick() {
    //index = index + 1;
     setIndex(index + 1) // dùng phương thức để thay đổi giá trị cho state888888
  }

  let sculpture = sculptureList[index]; //1
